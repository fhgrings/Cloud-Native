...
public class GitHubController {
	...
	@ResponseBody
	public ResponseEntity<TotalRepositoriesDto> getUserRepoTotal(@PathVariable(value = "username") String username) {
		try {
			return new ResponseEntity<>(apiService.getAllRepos(username), HttpStatus.OK);
